...
public class LrcWall2 extends FrameLayout {
    ...
    public LrcWall2(Context context) {
        super(context);
        initView(context);
    }

    public LrcWall2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public LrcWall2(Context context, AttributeSet attrs, int defStyleAttr) {
